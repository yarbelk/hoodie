#ifndef HOODIE_HNOFFSETCURVE2D_H
#define HOODIE_HNOFFSETCURVE2D_H
...
class HNOffsetCurve2D : public HoodieNode {
    GDCLASS(HNOffsetCurve2D, HoodieNode)
...
public:
    void set_polygon(const bool p_value);
    bool get_polygon() const;
    void set_xz(const bool p_value);
    bool get_xz() const;
...
#endif // HOODIE_HNOFFSETCURVE2D_H