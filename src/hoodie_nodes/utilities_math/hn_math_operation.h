#ifndef HOODIE_HNMATHOPERATION_H
#define HOODIE_HNMATHOPERATION_H
...
class HNMathOperation : public HoodieNode {
    GDCLASS(HNMathOperation, HoodieNode)
...
VARIANT_ENUM_CAST(HNMathOperation::Operation);

#endif // HOODIE_HNMATHOPERATION_H