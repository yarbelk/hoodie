#ifndef HOODIE_HNHGEODELETEEXPRESSION_H
#define HOODIE_HNHGEODELETEEXPRESSION_H
...
class HNHoodieGeoDeleteExpression : public HoodieNode {
    GDCLASS(HNHoodieGeoDeleteExpression, HoodieNode)
...
VARIANT_ENUM_CAST(HNHoodieGeoDeleteExpression::Target);

#endif // HOODIE_HNHGEODELETEEXPRESSION_H